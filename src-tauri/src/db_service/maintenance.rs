...
impl DbService {
    ...
    pub async fn register_maintenance(
        &self,
        equipo_id: &str,
        dependency: &str,
        fecha: DateTime<Utc>,
        ...
        let mut equipo = self
            .get_equipment_by_id(equipo_id, dependency)
            .await
            .expect("Equipo no encontrado")
            .unwrap();
        ...
        self.update_maintenance_statistics(fecha, dependency.to_string())
            .await?;
